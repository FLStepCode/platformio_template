 ...
 */
#define __HAL_SCR1_TIMER_ENABLE()   (SCR1_TIMER->TIMER_CTRL |= SCR1_TIMER_ENABLE_M)

/**
 * Запретить работу системного таймера.
 */
#define __HAL_SCR1_TIMER_DISABLE()  (SCR1_TIMER->TIMER_CTRL &= ~SCR1_TIMER_ENABLE_M)
...
typedef enum __HAL_SCR1_TIMER_ModeTypeDef
{
     ...
     */
    HAL_SCR1_TIMER_CLKSRC_INTERNAL = SCR1_TIMER_CLKSRC_INTERNAL_M,
    
    /**
     * @brief Тактирование от внешнего RTC
     */
    HAL_SCR1_TIMER_CLKSRC_EXTERNAL_RTC = SCR1_TIMER_CLKSRC_RTC_M
...
static inline __attribute__((always_inline)) void HAL_SCR1_Timer_SetClockSource(HAL_SCR1_TIMER_ModeTypeDef clockSource)
{
    ...
    case HAL_SCR1_TIMER_CLKSRC_INTERNAL:
        SCR1_TIMER->TIMER_CTRL &= ~SCR1_TIMER_CLKSRC_M;
        break;
